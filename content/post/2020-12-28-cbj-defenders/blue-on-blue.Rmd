...
s3d = scatterplot3d(def[,c("Defense","Offense","Finishing")], pch = 16, color=colors, grid=TRUE, box=FALSE)
```
...
cbj = def[team=="CBJ", c("player","cluster","gp","toi_even","Defense","Offense","Finishing")]
cbj_tab = cbj[order(-cbj$Defense)]
colnames(cbj_tab) = c("Player","Group","GP","EV TOI","Defense","Offense","Finishing")
